...
fun AddScreen() {
    ...
    var deadline by remember { mutableStateOf("") } // Menyimpan tanggal yang dipilih
    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                if (isValid) {
                    showMessage(context, "title: $title, pic: $pic, statusDescription: $statusDescription, deadline: $deadline")
                }
