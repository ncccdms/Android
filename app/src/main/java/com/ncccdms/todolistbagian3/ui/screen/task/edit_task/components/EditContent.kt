...
fun EditContent(
    ...
    var pic by remember { mutableStateOf(task?.pic ?: "") }
    var statusDescription by remember { mutableStateOf(task?.statusDesc ?: "") }
    ...
    Column(
        ...
        DatePickerDocked(
            ...
            initialDate = deadline, // Prefill the deadline field
